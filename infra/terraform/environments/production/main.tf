...
variable "dr_artifact_bucket_arn" { type = string }
variable "dr_artifact_kms_key_arn" { type = string }
...
module "control_plane" {
  ...
  repair_node_instance_types                      = ["m7g.2xlarge"]
  ...
  artifact_replication_destination_arn            = var.dr_artifact_bucket_arn
  artifact_replication_destination_kms_key_arn    = var.dr_artifact_kms_key_arn
  ecr_replication_region                          = var.dr_region
}
